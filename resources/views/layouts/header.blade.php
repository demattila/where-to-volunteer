                ...
                <div class="container">
                    ...
                    <a class="navbar-brand logo_h" href={{route('index')}}><img src={{url('img/wtv_n.svg')}} alt=""></a>
                        ...
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            ...
                            <li class="nav-item {{Request::path() ==='/' ? 'active' : ''}}"><a class="nav-link" href={{route('index')}}>Organization</a></li>
                        </ul>
                    ...
                    <div class="collapse navbar-collapse offset" id="navbarSupportedContent">
                        <ul class="nav navbar-nav menu_nav ml-auto">
                            <li class="nav-item {{Request::path() ==='/' ? 'active' : ''}}"><a class="nav-link" href={{route('index')}}>Home</a></li>
                            <li class="nav-item {{Request::path() ==='/about' ? 'active' : ''}}"><a class="nav-link" href={{route('about')}}>About</a></li>
                            <li class="nav-item {{Request::path() ==='/events' ? 'active' : ''}}"><a class="nav-link" href={{route('events')}}>Events</a></li>
                            {{--.--}}
                            @guest
                                <li class="nav-item">
